...
def test_footnote_parse_footer_with_highnotes(master89page7):
    parsed = groupme.footnotes.strategy.highnote.parse(master89page7)
    assert len(parsed) == 1, parsed


@utilatest.longrun
def test_footnote_highnotes_oneline_with_intention(bachelor111page10):
    parsed = groupme.footnotes.strategy.highnote.parse(bachelor111page10)
...
def test_highnotes_prepare():
    ...
    parsed = groupme.footnotes.strategy.highnote.parse(ITEMS)
