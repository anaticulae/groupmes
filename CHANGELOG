...
* happy New Year! (bf84bca60d0c)

### Chore

* use new pre step (15d554d3f2ee)
* upgrade Jenkinsfile (51f07bdf340f)
* upgrade pipe library (7145c750ae32)
* upgrade requirements.txt (f3f80cbacb65)

## v0.40.4 (2022-12-21)

### Chore

* use quick installer (949321ba4997)
* upgrade requirements.txt (fe573671f342)
* upgrade pipeline (e722092a116f)

## v0.40.3 (2022-12-04)

### Chore

* upgrade pipeline (27e8de157e12)
* upgrade requirements.txt (5da956bfab7f)
* upgrade pipe library (2c77619cbd12)
